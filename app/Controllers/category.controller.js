...
class CategoryController {
    ...
    listAllCategory = async (req, res, next) => {
        try {
            ...
            let response = await categoryService.getAllCategory({ page: currentPage, perPage: perPage })
            let meta = {
    ...
    createCategory = async (req, res, next) => {
        try {
            ...
            next({
                status: 400, msg: "Category creation errorr" + err
            })
        }
    ...
    updateCategory = async (req, res, next) => {
        try {
            ...
            next({
                status: 400, msg: "Category Update errorr" + err
            })
        }
        ...
        try {
            ...
            if (response) {
                if (response.image) {
                    ...
                    deleteImage(process.cwd() + "/public/uploads/category/", response.image);
                }
            ...
            next({
                status: 400, msg: "Category Deletion errorr " + err
            })
        }
